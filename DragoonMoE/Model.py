...
class InputEmbeddings(nn.Module):
    # d_model - dimension of the vector (size of the Embedding of each token) rather 512
...
class PositionalEncoding(nn.Module):
    # seq_len - maximum length of the sentence because we need to create one vector for each position
    # dropout - to make the modl less overfit
    def __init__(self, d_model: int, seq_len: int, dropout: float) -> None:
        ...
        # Slicing under this comment means that every word in the even dimensions will recieve sin
...
def build_transformer(src_vocab_size: int, tgt_vocab_size: int, src_seq_len: int, tgt_seq_len: int):
    print("TODO implement transformer")
    print("TODO switch FFN to MoE")
